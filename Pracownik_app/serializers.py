...
class KsiazkaSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model=Ksiazka
        fields=('ISBN','TytulKs','AutorKs','CenaKs', 'Ilosc','Opis','Zdjecie','DodalIdP')
...
class ZamowienieSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model=Zamowienie
        fields=('IdZ','DataZ','Status','Adres','LiczbaKs','LoginK','IdKs')
...
class RecenzjaSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model=Recenzja
        fields=('IdR','TrescR','DataWyst','LoginK','IdKs', 'Ocena')
